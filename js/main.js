$(document).ready(function(){
    ...
    $(window).scroll(function(){
        ...
        if (scroll >= 150){
            $('.navbar_area').addClass('bgChange');
            $('.navbar_area .rigt_navbar nav.desktop-navbar ul li a').addClass('menulinksColor');
        }
        else{
            $('.navbar_area').removeClass('bgChange');
            $('.navbar_area .rigt_navbar nav.desktop-navbar ul li a').removeClass('menulinksColor');
